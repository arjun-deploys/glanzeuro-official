...
export const whatWeDo = [
  {
    number: "01",
    title: "Speaking",
    copy: "Build confidence through regular speaking practice.",
  },
  {
    number: "02",
    title: "Listening",
    copy: "Train your ear for everyday language and rhythm.",
  },
  {
    number: "03",
    title: "Reading",
    copy: "Make meaning from real words, signs and stories.",
  },
  {
    number: "04",
    title: "Writing",
    copy: "Shape clear messages for study, work and life.",
  },
  {
    number: "05",
    title: "Grammar & Vocabulary",
    copy: "Build strong fundamentals you can actually use.",
  },
  {
    number: "06",
    title: "Practical Conversation",
    copy: "Move from the lesson into confident conversations.",
  },
]
...
export const frenchLevels = [
  {
    level: "A1",
    name: "Beginner",
    copy: "French A1 — Beginner",
    href: "/french/a1",
  },
  {
    level: "A2",
    name: "Elementary",
    copy: "French A2 — Elementary",
    href: "/french/a2",
  },
  {
    level: "B1",
    name: "Intermediate",
    copy: "French B1 — Intermediate",
    href: "/french/b1",
  },
  {
    level: "B2",
    name: "Upper Intermediate",
    copy: "French B2 — Upper Intermediate",
    href: "/french/b2",
  },
]
...
export const dutchLevels = [
  {
    level: "A1",
    name: "Beginner",
    copy: "Dutch A1 — Beginner",
    href: "/dutch/a1",
  },
  {
    level: "A2",
    name: "Elementary",
    copy: "Dutch A2 — Elementary",
    href: "/dutch/a2",
  },
  {
    level: "B1",
    name: "Intermediate",
    copy: "Dutch B1 — Intermediate",
    href: "/dutch/b1",
  },
  {
    level: "B2",
    name: "Upper Intermediate",
    copy: "Dutch B2 — Upper Intermediate",
    href: "/dutch/b2",
  },
]
...
export const testimonials = [
  {
    quote:
      "The speaking practice made me stop translating every sentence in my head. I finally feel comfortable starting a conversation.",
    name: "Aarav S.",
    course: "French A1",
  },
  {
    quote:
      "The classes are structured, warm and very practical. I could use what I learnt immediately at work.",
    name: "Maya R.",
    course: "Dutch A2",
  },
  {
    quote:
      "I started as a complete beginner and now I can introduce myself, ask questions and keep going when I make a mistake.",
    name: "Nisha K.",
    course: "French A1",
  },
  {
    quote:
      "The lessons give you a clear rhythm. Listening, speaking, vocabulary — everything connects and feels manageable.",
    name: "Daniel P.",
    course: "Dutch B1",
  },
  {
    quote:
      "What I value most is the confidence. It feels less like memorising a language and more like finding your voice.",
    name: "Sara M.",
    course: "French B1",
  },
]
